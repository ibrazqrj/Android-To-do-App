...
namespace TodoApi.Controllers
{
    ...
    public class TodoController : ControllerBase
    {
        ...
        [HttpGet]
        public async Task<ActionResult<IEnumerable<TodoItem>>> GetTodos([FromQuery] int offset = 0, [FromQuery] int limit = 10)
        {
            ...
            var todos = await _context.TodoItems.Where(t => t.UserId == userId)
                .Skip(offset)
                .Take(limit)
                .ToListAsync();
